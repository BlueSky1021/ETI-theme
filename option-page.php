...
<?php include('includes/header.php'); ?>
        <style>
         ...
         #menu-main-menu{margin: 20px 0 !important;}
          .darkblue-bg-color{background-color: #024b67!important;}
    ...
    -webkit-box-shadow: 0 0 5px 0 rgba(0,0,0,.24);
        ...
        <section class="optionpage-wrapper">
            <div class="optionpage-banner-carousel">
              <div class="item banner-section view vh100 secondary-light-bg-color background-reset position-fixed width-100-percent overflow-y-auto" style="background-image: url('<?php bloginfo('template_directory'); ?>/assets/images/backgrounds/option-page-banner.jpg');">
              <div class="center-position-top-60 width-100-percent">
                <div class="container">
                  <div class="row">
                    <div class="col-sm-7 grid-centered">
                      <div class="option-wrapper" style="margin-top: 0;">
                        <h1 class="proximanova-bold primary-font-color px-28-font text-uppercase text-center no-margin">Which Student Are You?</h1>
...
<!--           <div class="item banner-section view vh100 secondary-light-bg-color background-reset position-fixed width-100-percent overflow-y-auto" style="background-image: url('<?php bloginfo('template_directory'); ?>/assets/images/backgrounds/option-page-carpentry-security.jpg');">
              <div class="center-position-top-60 width-100-percent">
                <div class="container">
                  <div class="row">
                    <div class="col-sm-7 grid-centered">
                      <div class="option-wrapper" style="margin-top: 0;">
                        <h1 class="primary-font-color px-28-font text-uppercase text-center no-margin">Which Student Are You?</h1>
                        <div class="clearfix" style="height: 5px;"></div>
                        <?php wp_nav_menu( array( 'theme_location'  => 'site-option-page-menu','menu' => '','container' => 'ul','container_class' => '','container_id' => '','menu_class' => 'course-page-option large-block-grid-3 medium-block-grid-2 small-block-grid-2 centered-last-row','menu_id' => '','echo' => true,'fallback_cb' => 'wp_page_menu','before' => '','after' => '','link_before' => '','link_after' => '','items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>','depth' => 0,'walker' => '') ); ?>
                        <div class="clearfix" style="height: 5px;"></div>
                        <ul class="certification-number list-inline center-block px-14-font primary-font-color" style="margin-bottom: 0;">
