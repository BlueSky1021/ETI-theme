<?php 
/*
Template name: Carpentry Courses
*/
 ?>
<?php get_template_part('includes/header-hospitality'); ?>
<style type="text/css">
...
.our-course-section .course-list .list-item .item-explore-cta-btn.darkblue-background {
    ...
    -webkit-box-shadow: 0 0 5px 0 rgba(0,0,0,.24);
        ...
        <!-- Banner Section --> 
        <section class="banner-section banner-curve-style view vh79 primary-bg-color background-reset position-relative" style="background-image: url('<?php bloginfo('template_directory'); ?>/assets/images/backgrounds/QLD-VIC-INT-Hospitality.jpg'); background-position-y: 10%;">
              ...
              <div class="row">
                <div class="col-lg-10 grid-centered">
                  <div class="banner-caption text-center white-font-color">
                    <h1 class="proximanova-bold px-72-font no-margin text-uppercase line-height-1">CARPENTRY COURSES</h1>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="our-courses-content">
                      <div class="col-md-12">
                        <div class="page-subtitle">
                          ...
                          <h1 class="darkblue-font-color px-44-font proximanova-bold no-margin">Carpentry Courses</h1>
                        </div>
                      </div>  
                            ...
                            <div class="col-md-6">
                                    <div class="list-item box">
                                      ...
                                      <div class="item-content position-relative">
                                         <p class="course-description px-12-font text-align-center-justify"><?php echo excerpt(35); ?></p>
                                      </div>
                                      <div class="row">
                                        <div class="col-lg-12">
...
<?php get_template_part('includes/footer-hospitality'); ?>
