...
<?php include('includes/header.php'); ?>
        <style>
         ...
         /*hospitality styles*/
         #menu-main-menu{margin: 20px !important;}
        .navbar-brand{padding: 15px 5px !important;}
        .queensland, .victoria{display: none !important;}
...
.our-course-section .course-list .list-item .item-explore-cta-btn.darkblue-background {
    ...
    -webkit-box-shadow: 0 0 5px 0 rgba(0,0,0,.24);
        ...
        <section class="optionpage-wrapper">
          ...
          <div class="item hospitality-item banner-section view vh100 secondary-light-bg-color background-reset position-fixed width-100-percent overflow-y-auto" style="background-image: url('<?php bloginfo('template_directory'); ?>/assets/images/backgrounds/QLD-VIC-INT-Hospitality.jpg'); ">
              <div class="center-position-top-60 width-100-percent">
                <div class="container">
                  <div class="row">
                    <div class="col-sm-7">
                      <div>
                        <h1 class="proximanova-bold px-60-font white-font-color no-margin line-height-1 display-inlineblock" style="vertical-align: -webkit-baseline-middle; text-shadow: 0px 3px 7px rgba(0, 0, 0, 0.35);">Hospitality</h1>
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/icons/wine-glass.png" alt="" class="img-responsive " style="margin-left: 5px;display: inline-block!important;">
                      </div>
                      <div class="option-wrapper">
                        <h1 class="primary-font-color px-28-font text-uppercase text-center no-margin">Select Your Location</h1>
                        <div class="clearfix" style="height: 5px;"></div>
                        <?php wp_nav_menu( array( 'theme_location'  => 'hospitality-site-option-page-menu','menu' => '','container' => 'ul','container_class' => '','container_id' => '','menu_class' => 'course-page-option large-block-grid-3 medium-block-grid-2 small-block-grid-2 centered-last-row','menu_id' => '','echo' => true,'fallback_cb' => 'wp_page_menu','before' => '','after' => '','link_before' => '','link_after' => '','items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>','depth' => 0,'walker' => '') ); ?>
                        <div class="clearfix" style="height: 5px;"></div>
