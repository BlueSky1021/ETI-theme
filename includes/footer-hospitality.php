          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="logo-widget center-block">
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/logos/ETI-whitetext-logo.png" alt="" class="img-responsive">
              </div>
              ...
              <div class="menu-widget">
                <?php wp_nav_menu( array( 'theme_location'  => 'hospitality-footer-menu','menu' => '','container' => 'ul','container_class' => '','container_id' => '','menu_class' => 'list-inline px-12-font center-block text-uppercase','menu_id' => '','echo' => true,'fallback_cb' => 'wp_page_menu','before' => '','after' => '','link_before' => '','link_after' => '','items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>','depth' => 0,'walker' => '') ); ?>   
              </div>
