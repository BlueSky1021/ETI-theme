 ...
 <head>
  ...
  <?php elseif (is_search()) : ?>
    <title><?php printf(__("Search results for '%s'", "theme"), attribute_escape(get_search_query())); ?> | <?php bloginfo('name'); ?></title>
  <?php else : ?>
  ...
  <?php endif; ?>
   ...
   <link rel="icon" sizes="192x192" href="<?php bloginfo('template_directory'); ?>/favicon.png">
 ...
 <body <?php body_class(); ?>>
   <main id="main" class="main" role="main">
     ...
     <header id="header" class="header">
       ...
       <nav class="navbar navbar-default header-wrapper header-curve-style white-bg-color no-margin no-border">
         <div class="container header-container">
           ...
           <div class="collapse navbar-collapse" id="navbar-collapse">
             <div class="row">
               <div class="col-lg-8 no-padding pull-right">
                 <div class="text-uppercase" style="margin-top: 10px;">
                   <div class="col-lg-12 no-padding">

                     <?php wp_nav_menu(array('theme_location'  => 'top-menu', 'menu' => '', 'container' => 'ul', 'container_class' => '', 'container_id' => '', 'menu_class' => 'px-12-font proximanova-semibold nav navbar-nav navbar-right no-margin', 'menu_id' => '', 'echo' => true, 'fallback_cb' => 'wp_page_menu', 'before' => '', 'after' => '', 'link_before' => '', 'link_after' => '', 'items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>', 'depth' => 0, 'walker' => '')); ?>
                   ...
                   <div class="col-lg-12 no-padding">
                     <?php wp_nav_menu(array('theme_location'  => 'main-menu', 'menu' => '', 'container' => 'ul', 'container_class' => '', 'container_id' => '', 'menu_class' => 'px-12-font proximanova-semibold nav navbar-nav navbar-right no-margin', 'menu_id' => '', 'echo' => true, 'fallback_cb' => 'wp_page_menu', 'before' => '', 'after' => '', 'link_before' => '', 'link_after' => '', 'items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>', 'depth' => 0, 'walker' => '')); ?>
                   </div>
                 </div>
               </div>
             </div>
