                ...
                <div class="col-lg-8 no-padding">
                  <div class="text-uppercase" style="margin-top: 10px;">
                    <div class="col-lg-12 no-padding">        
                      ...
                      <?php wp_nav_menu( array( 'theme_location'  => 'custom-top-menu','menu' => '','container' => 'ul','container_class' => '','container_id' => '','menu_class' => 'px-12-font proximanova-semibold nav navbar-nav navbar-right no-margin','menu_id' => '','echo' => true,'fallback_cb' => 'wp_page_menu','before' => '','after' => '','link_before' => '','link_after' => '','items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>','depth' => 0,'walker' => '') ); ?>   
                    ...
                    <div class="col-lg-12 no-padding">
                      <?php wp_nav_menu( array( 'theme_location'  => 'custom-main-menu','menu' => '','container' => 'ul','container_class' => '','container_id' => '','menu_class' => 'px-12-font proximanova-semibold nav navbar-nav navbar-right no-margin','menu_id' => '','echo' => true,'fallback_cb' => 'wp_page_menu','before' => '','after' => '','link_before' => '','link_after' => '','items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>','depth' => 0,'walker' => '') ); ?>   
                    </div>
                  </div>
                </div>
              </div>
